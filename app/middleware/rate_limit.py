...
def rate_limit_dependency(request: Request) -> None:
    ...
    # raises `RateLimitExceeded` when the limit is hit. Passing the Request object ensures
    # both headers (for API key lookup) and path are available to the limiter.
